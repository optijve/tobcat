                                ...
                                bool baseFormatSave )
{
	...
	// --------------------------------------------------------------------------------------
	// Add functionality in order to visualize calculation time required for each stage
    ...
    for( int i = startNumStages; i < numStages; i++ )
    {
        ...
        if( tempLeafFARate <= requiredLeafFARate )
        {
			...
			// ---------------------------------------------------------------------------------------------------
			// Add functionality in order to visualize calculation time required for each stage
			cout << "<CALCULATION TIME FOR PREVIOUS STAGE : ";
			...
			cout << days << " DAYS " << hours << " HOURS " << minutes << " MINUTES " << seconds_left <<" SECONDS>" << endl;
			// ---------------------------------------------------------------------------------------------------
