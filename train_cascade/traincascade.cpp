...
int main( int argc, char* argv[] )
{
    ...
    // FOR TOBCAT - removed all parameters that should not be specified for using this interface in TOBCAT workshop
    if( argc == 1 )
    {
        cout << "---- [ADAPTED INTERFACE FOR TOBCAT PROJECT] ----" << endl;
